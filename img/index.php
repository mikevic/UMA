	  ...
	  <div class="row">
		...
		<div class="span4">
		  ...
		  <div class="hero-unit">
			...
			<p>Usha Menon Management Consultancy works with nonprofit and social purpose organisations in Asia to strengthen skills, abilities, processes and resources. We provide client-focused consultancy and training in Management, Leadership Development, and Fundraising & Philanthropy. We are a global consultancy with a focus on Asia.
</p>
	    ...
	    <div class="span12 content_box_span" id="content_box2_span">
			<div class="hero-unit content_box" id="content_box2">
				...
				<ul STYLE="list-style-image: url(img/bullet.png)">
					<li><p style="line-height:1.65;"><img src="img/vaswani.jpg" width="150px" align="right" style="padding:10px">Usha Menon contributed to the book 'Revealing Indian Philanthropy,' a London School of Economics publication in collaboration with Swiss Bank UBS. Other contributors to this book include Adi Godrej, Rohini Nilekani, Shiv Nader, Rajshree Birla, G.M Rao among others.</p>

<p>The global launch of the book was held in Singapore last week in the presence of Dada Vaswani, spiritual leader of the Sadhu Vaswani mission and witnessed by the ultra-high net-worth Indian clients of UBS. <a href="media/THIP.pdf" target="_blank">Read More >></a></p></li>
					<li><p style="line-height:1.65;">Usha’s blog posts on insights from San Diego,  <a href="http://ushamenonasia.com/blog/?p=199">part 1</a>  and <a href="http://ushamenonasia.com/blog/?p=210">part 2</a>. Also read Usha’s blog on <a href="http://ushamenonasia.com/blog/?p=141">‘How to engage the Indian community’</a>.</p></li>
			</div>
       </div>
...
<ul id="ticker">
	...
	<li>
		...
		<div class="span6">
			<div class="hero-unit" id="tweet_slider"/>
			<div class="tweet" id="tweet_ticker"></div>
			</div>
		</div>
		<div class="row">
