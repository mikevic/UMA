...
$(document).ready(function() {
    ...
    if (e.which == 13) {
    var search_term = $('#search_button').val();
    search_term = search_term.replace(" ", "+");
    var url = 'https://www.google.co.in/search?q=site:ushamenonasia.com+'+search_term;
    window.location = url;
  }
});
});
        ...
        <div class="container">
	      ...
	      <li <?php if($current_page == 'contact.php') { echo 'class="active"';}?>><a href="contact.php"><b>Contact</b></a></li>
			...
			<ul class="nav pull-right"> 
				...
				<li><a id="search_bar"><input type="text" class="search-query" placeholder="Search" id="search_button"></a></li>
