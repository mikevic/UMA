...
<h4><?php printf($comment_count > 1 ? __('<span>%d</span> Comments', 'blankslate') : __('<span>One</span> Comment', 'blankslate'), $comment_count) ?></h3>
...
<div id="respond">
<h4><?php comment_form_title( __('Post a Comment', 'blankslate'), __('Post a Reply to %s', 'blankslate') ); ?></h4>
